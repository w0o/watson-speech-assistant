...
/* global ConversationApi: true, Common: true, PayloadPanel: true*/
...
var PayloadPanel = (function() {
  ...
  function payloadUpdateSetup() {
    ...
    ConversationApi.setResponsePayload = function(newPayload) {
      currentResponsePayloadSetter.call(ConversationApi, newPayload);
  ...
  function displayPayload(typeValue) {
    ...
    if (isRequest !== null) {
      ...
      if (ConversationApi.getRequestPayload() || ConversationApi.getResponsePayload()) {
  ...
  function buildPayloadDomElement(isRequest) {
    var payloadPrettyString = jsonPrettyPrint(isRequest
      ? ConversationApi.getRequestPayload() : ConversationApi.getResponsePayload());
